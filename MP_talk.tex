...
\begin{frame}
	\frametitle{Madness}
	Incautiously used, this leads to the dangers of MP:
	\begin{itemize}
		\item Opaqueness
...
\begin{frame}
	...
	\pause
	\vskip 0.5cm
	Turn:  ``am\={o}, am\={a}re, am\={a}v\={\i}, amatum''
	\vskip 0.5cm
	\pause
	Into:  $\approx$ 160$+$ unique forms per verb
\end{frame}
...
\end{frame}
\note{
Earlier I showed you that a tense-block was basically an array but that it
gained the ability to have some ambiguous methods called on it. Here's how I
gained that.
}
...
\begin{frame}
	...
	\end{itemize}
\end{frame}
\note{I believe these first two benefits are obvious, so instead I'll focus on one that i find particularly aesthetically unpleasing.}
