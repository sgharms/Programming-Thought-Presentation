...
\begin{frame}
	...
	Occasionally we want to cluster unique vectors or leave out an aspect to get a less-granular result
	\pause
	\begin{itemize}
...
\begin{frame}
	...
	\pause
	\vskip 0.5cm
	Vectors should be accessed by pretty method calls like: \texttt{active\_voice\_indicative\_mood\_present\_tense{\ldots}\\\_first\_person\_singular\_number}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\pause
		\item Saved creating \textbf{\$A\_LOT\_OF} additional methods per tense -- \emph{many of which I didn't even think of!}
	\end{itemize}
\end{frame}
